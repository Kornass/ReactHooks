  ...
  return (
    <div className="container flex flex-col justify-center items-center w-2/3">
      ...
      <p className="bg-orange-100 border rounded p-2">
        ...
        <p>
          Custom Hooks are named with "use" as prefix. For example, a custom
          hook could be named useLocalStorage or useAuthentication. In our case,
          the custom hook will be named useFetch. Custom Hooks consist of
          built-in React Hooks or other custom Hooks. Therefore a custom Hook is
          always a new composition of one or multiple Hooks. If a custom Hook
          does not use any hooks internally, it's not a custom Hook and
          shouldn't have the prefix "use".
        </p>
      </p>
      <p className="bg-orange-100 border rounded p-2">
